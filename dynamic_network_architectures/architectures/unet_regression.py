...
from dynamic_network_architectures.building_blocks.unet_decoder_regression import UNetDecoder_regression
...
class PlainConvUNet_regression(AbstractDynamicNetworkArchitectures):
    def __init__(
        self,
        input_channels: int,
        n_stages: int,
        ...
        self.decoder = UNetDecoder_regression(
...
if __name__ == "__main__":
    ...
    model = PlainConvUNet_regression(
        4,
        6,
